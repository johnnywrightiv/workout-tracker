    ...
    <div className="container mx-auto space-y-8 px-4 py-8">
      <div className="w-full space-y-4">
        <div className="flex w-full flex-wrap items-center justify-between gap-4">
          <h1 className="w-full text-3xl font-bold sm:w-auto sm:text-4xl">
            Past Workouts
          </h1>
          <h2 className="mx-2 mt-2 rounded-md bg-yellow-900 px-4 py-2 text-center text-sm font-semibold italic text-yellow-200 shadow-md">
            REMEMBER: you EARN progressive overload through proper REST &
            RECOVERY, not by FORCING extra strength during workouts!!
          </h2>

          {/* Filter and Sort Controls */}
          <div className="flex w-full flex-row justify-end gap-4 sm:w-auto">
            ...
            <div className="w-1/2 sm:w-auto">
              {isMobile ? (
                <Drawer>
                  ...
                  <DrawerContent>
                    <div className="mx-auto w-full max-w-sm pl-2">
                      <FilterContent
                        filters={filters}
